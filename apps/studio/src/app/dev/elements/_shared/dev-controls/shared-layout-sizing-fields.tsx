...
function readResponsiveChoiceState<TValue extends string>(
  value: PbImageVariantDefaults["selfAlign"] | PbImageVariantDefaults["alignY"],
  fallback: TValue
...
export function SharedLayoutSizingFields({
  ...
  const align = readResponsiveChoiceState<AlignX>(variant.selfAlign, "center");
  ...
  return (
    <>
      ...
      <AlignmentFields
        ...
        alignY={alignY}
      />
      <ZIndexField value={variant.layer} onPatch={onPatch} />
      <ConstraintsFields
