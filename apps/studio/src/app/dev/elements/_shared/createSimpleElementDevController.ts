  ...
  return function useSimpleElementDevController() {
    ...
    const copyExport = useCallback(async () => {
      try {
        ...
        console.warn("[web] Failed to copy simple element export to clipboard", err);
      }
    }, [exportJson]);
    ...
    return {
      ...
      patchEntranceFineTune:
        patchEntranceFineTune as PbAnimationLabController["patchEntranceFineTune"],
      patchExitFineTune: patchExitFineTune as PbAnimationLabController["patchExitFineTune"],
      resetDefaults,
      runtimeDraft,
      runtimePreview,
      setAnimationPatch: setAnimationPatch as PbAnimationLabController["setAnimationPatch"],
      setDefaultVariant,
      setEntranceBezierValue:
        setEntranceBezierValue as PbAnimationLabController["setEntranceBezierValue"],
      setEntranceCurvePreset:
        setEntranceCurvePreset as PbAnimationLabController["setEntranceCurvePreset"],
      setExitBezierValue: setExitBezierValue as PbAnimationLabController["setExitBezierValue"],
      setExitCurvePreset: setExitCurvePreset as PbAnimationLabController["setExitCurvePreset"],
      setRuntimePatch,
      setVariantExact,
      setVariantPatch,
