...
import type { ThemeStringLike } from "@/app/dev/elements/_shared/theme-string";
...
export function normalizeScrollProgressBarVariant(
  ...
  return {
    ...
    fill: pickString(incoming.fill, seed.fill as ThemeStringLike | undefined) as typeof seed.fill,
...
export function readPersistedScrollProgressBar(): PersistedScrollProgressBarDefaults | null {
  ...
  try {
    ...
    console.warn("[web] Failed to normalize scroll-progress-bar element defaults", err);
    return null;
  }
}
