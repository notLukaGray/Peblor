...
import { modalBuilderSchema } from "@pb/contracts/peblor/core/peblor-schemas/modal-block-schemas";
  ...
  return {
    ...
    form: {
      ...
      fields: [
        ...
        { type: "formField", fieldType: "button", buttonType: "submit", label: "Join" },
      ],
    },
    footer: {
      type: "contentBlock",
