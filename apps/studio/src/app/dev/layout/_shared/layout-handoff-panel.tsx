...
function safeReadVisibilityStorage(): string | null {
  try {
    ...
    console.warn("[web] Failed to read layout handoff visibility from localStorage", err);
    return null;
  }
}
...
function safeWriteVisibilityStorage(nextVisible: boolean): void {
  try {
    ...
    console.warn(
      "[web] Failed to write layout handoff visibility (private mode / blocked storage)",
      err
    );
  }
}
