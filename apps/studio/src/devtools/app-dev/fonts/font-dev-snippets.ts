...
// TYPE_SCALE_LEGACY_KEYS and TYPE_SCALE_PREVIOUS_TSHIRT_SLOT_MAP are exported from
// the canonical `@/app/fonts/type-scale` — import from there if needed.
...
// Legacy key maps (TYPE_SCALE_LEGACY_KEYS, TYPE_SCALE_PREVIOUS_TSHIRT_SLOT_MAP) removed from this
// template — import from @/app/fonts/type-scale instead when needed.
`;
