...
import type { ElementBlock, ElementBodyVariant, MotionTiming } from "@pb/contracts/types";
...
import { ClientMixedRichTextShell } from "../../client-islands/ClientMixedRichTextShell";

type RichTextBase = Extract<ElementBlock, { type: "elementRichText" }>;
...
export function MixedServerElementRichText({
  content,
  markup,
  ...
  const safeMarkup = hasMarkup ? sanitizeRichTextMarkup(markup) : undefined;
  ...
  return (
    <ClientMixedRichTextShell
      width={width as string | [string, string] | undefined}
      height={height as string | [string, string] | undefined}
      align={align as MixedRichTextIslandAlign | undefined}
      textAlign={textAlign as string | [string, string] | undefined}
      marginTop={marginTop as string | [string, string] | undefined}
      marginBottom={marginBottom as string | [string, string] | undefined}
      marginLeft={marginLeft as string | [string, string] | undefined}
      marginRight={marginRight as string | [string, string] | undefined}
      wordWrap={wordWrap}
      motionTiming={motionTiming as MotionTiming | undefined}
