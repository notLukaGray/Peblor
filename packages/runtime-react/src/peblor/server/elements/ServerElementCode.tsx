...
export function ServerElementCode({
  code,
  language,
  wrap,
  showLineNumbers,
  ...
  const codeClassName =
    language !== undefined && language !== "" ? `language-${language}` : undefined;
  ...
  return (
    <div
      ...
      style={layoutStyle}
    >
      <pre style={preStyle} {...(showLineNumbers === true ? { "data-line-numbers": true } : {})}>
